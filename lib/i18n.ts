...
export const translations = {
  en: {
    ...
    blog: {
      ...
      posts: [
        { cat: "Infrastructure", title: "Unveiling the Future with WiFi 7: Ruijie's RG-RAP73HD Leads the Charge", desc: "WiFi 7 is here and it's changing the game. Explore how Ruijie's latest access point delivers next-gen wireless performance with an innovative SFP+ port for fiber connectivity.", date: "Mar 1, 2024", read: "2 min read" },
        { cat: "Cloud", title: "Microsoft's Copilot: The Future of Productivity Unleashed", desc: "How Microsoft's AI-powered Copilot is transforming the way businesses work — integrated into Word, Excel, Outlook, and Teams.", date: "Feb 21, 2024", read: "2 min read" },
        { cat: "Infrastructure", title: "InfiniBand VS Ethernet", desc: "A deep technical comparison of InfiniBand and Ethernet for data center networking — speed, latency, RDMA, and scalability.", date: "Feb 20, 2024", read: "3 min read" },
        { cat: "Cloud", title: "The Evolution of Cloud Computing: Trends and Predictions for the Future", desc: "From hybrid multi-cloud strategies to serverless computing and AI integration — the key trends shaping the future.", date: "Jan 23, 2024", read: "3 min read" },
        { cat: "Migration", title: "Adopting Agility in IT Daily Life", desc: "A 15-step guide to adopting Agile principles and practices to enhance collaboration, flexibility, and responsiveness in IT teams.", date: "Nov 28, 2023", read: "3 min read" },
        { cat: "Sustainability", title: "The Role of IT in Ensuring Business Continuity", desc: "Why a robust IT infrastructure is critical for business continuity — from disaster recovery to remote work enablement.", date: "Nov 21, 2023", read: "2 min read" },
      ],
    },
    contact: {
      eyebrow: "Contact Us",
  ...
  ar: {
    ...
    projects: {
      ...
      items: [
        { icon: "👟", color: "blue", title: "نايك تركيا — هجرة متعددة المواقع", desc: "هجرة شبكية ناجحة عبر 9 متاجر نايك في 9 مدن تركية مع فرق متعددة الجنسيات.", fullDesc: "نفخر بإتمام مشروع هجرة ناجح لمتاجر نايك تركيا عبر تسعة مواقع ومدن مختلفة. تحقق هذا الإنجاز بفضل تعاون فرق متعددة الجنسيات.", bullets: ["التحقق من BOM: فحص الأجهزة والكابلات", "مسح الكابلات والتسمية: مسح مسبق وتسمية جميع المحولات", "إزالة الأجهزة: إزالة أجهزة الشبكة من الرف الرئيسي", "تركيب المحولات الجديدة", "إعادة تصميم الرفوف", "التوصيلات بين المحولات ولوحات التوصيل", "اختبار الدخان: فحص جميع الأنظمة"], tags: ["هجرة", "9 مواقع", "تركيب"], location: "تركيا — 9 مدن" },
        { icon: "💻", color: "green", title: "دعم L1 في الموقع — إسطنبول", desc: "مشروع هجرة مدته 24 شهرًا في إسطنبول لنشر صورة Windows 11.", fullDesc: "أنهى فريق مهندسي الدعم لدينا بنجاح مشروع هجرة مدته 24 شهرًا في إسطنبول، تركيا. تضمنت مهمتهم الأساسية مساعدة المستخدمين النهائيين بتزويدهم بأجهزة مجهزة بصورة Windows 11 الجديدة.", tags: ["دعم L1", "Windows 11", "24 شهر"], location: "إسطنبول، تركيا" },
        { icon: "🔌", color: "amber", title: "تصميم كابلات مركز البيانات", desc: "تحويل مصفوفة توصيل الكابلات إلى تصميم احترافي متكامل.", fullDesc: "قدم لنا مصفوفة توصيل الكابلات وسيحولها فريقنا المتخصص إلى تحفة فنية في مركز بيانات العميل.", tags: ["كابلات", "مركز بيانات", "تصميم"], location: "مركز بيانات العميل" },
        { icon: "♻", color: "cyan", title: "Go Green — تفكيك الشبكات", desc: "تفكيك صديق للبيئة للأجهزة منتهية الصلاحية مع حذف آمن للبيانات.", fullDesc: "مع اقتراب أجهزة الشبكة من نهاية عمرها الافتراضي، يتكثف دورنا كشريك موثوق في تقليل النفايات الإلكترونية. نعطي الأولوية للحذف الآمن للبيانات قبل تسليم الأجهزة لشريكنا في إعادة التدوير.", tags: ["Go Green", "تفكيك", "أمن"], location: "مواقع متعددة" },
        { icon: "🔥", color: "blue", title: "تركيب جدار حماية Palo Alto PA-440", desc: "تركيب ناجح لجدران حماية Palo Alto في مركز بيانات العميل.", fullDesc: "أنهى فريق البنية التحتية لدينا بنجاح تركيب جدران حماية Palo Alto في مركز بيانات العميل، بما في ذلك تركيب الأجهزة في حوامل الرفوف.", tags: ["جدار حماية", "Palo Alto", "مركز بيانات"], location: "مركز بيانات العميل" },
        { icon: "📡", color: "green", title: "ترقية الشبكة — موقع التصنيع", desc: "تهيئة وتركيب أجهزة شبكة جديدة بما فيها نقاط وصول Cisco.", fullDesc: "أنجزنا مؤخرًا مشروعًا مؤثرًا لعميل في موقع التصنيع، مع التركيز على تحسين البنية التحتية للشبكة.", bullets: ["استلام وتهيئة أجهزة شبكة متنوعة", "تركيب وتأمين نقاط وصول Cisco لتغطية أفضل", "العمل عن كثب مع العميل لتقليل الاضطراب"], tags: ["Cisco", "WiFi", "تصنيع"], location: "موقع التصنيع" },
        { icon: "🖥", color: "amber", title: "تركيب وتكديس — 60 خادمًا", desc: "تركيب وتكديس 60 خادمًا في مركز بيانات العميل في إسطنبول.", fullDesc: "قام فريق البنية التحتية لدينا بتركيب وتكديس 60 خادمًا في مركز بيانات العميل في تركيا — إسطنبول.", tags: ["تركيب", "60 خادم", "مركز بيانات"], location: "إسطنبول، تركيا" },
        { icon: "📶", color: "cyan", title: "مسح WiFi وخرائط التغطية", desc: "مسح شامل لشبكة WiFi مع خرائط حرارية تفصيلية لتحسين التغطية.", fullDesc: "أجرى فريقنا من المهندسين اللاسلكيين مسحًا شاملاً لشبكة WiFi في موقع تصنيع العميل، مما أسفر عن خرائط حرارية دقيقة لتحسين التغطية.", tags: ["WiFi", "خريطة حرارية", "تصنيع"], location: "موقع التصنيع" },
  ...
  tr: {
    ...
    projects: {
      ...
      items: [
        ...
        { icon: "🖥", color: "amber", title: "Rack Kurulumu — 60 Sunucu", desc: "İstanbul'da 60 sunucu kurulumu.", fullDesc: "Altyapı ekibimiz Türkiye — İstanbul'daki müşteri veri merkezinde 60 sunucuyu kurdu ve istifledi.", tags: ["Rack Kurulumu", "60 Sunucu", "Veri Merkezi"], location: "İstanbul, Türkiye" },
        { icon: "📶", color: "cyan", title: "WiFi Anketi ve Isı Haritalaması", desc: "Kapsamlı WiFi anketi ve ısı haritaları.", fullDesc: "Yetenekli kablosuz mühendislerimiz müşterinin üretim tesisinde kapsamlı bir WiFi anketi gerçekleştirerek kapsama optimizasyonu için titizlikle hazırlanmış WiFi ısı haritaları oluşturdu.", tags: ["WiFi Anketi", "Isı Haritası", "Üretim"], location: "Üretim Tesisi" },
