...
export const translations = {
  en: {
    ...
    projects: {
      ...
      outcome: "Outcome",
      services: "Services",
      similarChallenge: "Got a similar challenge?",
      similarChallengeSub: "Tell us about your project — we typically reply within a day.",
      startConversation: "Start a conversation",
      nextStep: "Next Step",
      readyHeadline: "Ready for results like these?",
      readySub: "Talk to our engineering team about your migration, datacenter, or network project.",
      items: [
        {
  ...
  ar: {
    ...
    projects: {
      ...
      outcome: "النتيجة",
      services: "الخدمات",
      similarChallenge: "هل لديك تحدٍّ مماثل؟",
      similarChallengeSub: "حدِّثنا عن مشروعك — عادةً ما نرد خلال يوم واحد.",
      startConversation: "ابدأ المحادثة",
      nextStep: "الخطوة التالية",
      readyHeadline: "جاهز لنتائج كهذه؟",
      readySub: "تحدث إلى فريق الهندسة لدينا حول مشروع الهجرة أو مركز البيانات أو الشبكة.",
      items: [
  ...
  tr: {
    ...
    projects: {
      ...
      outcome: "Sonuç",
      services: "Hizmetler",
      similarChallenge: "Benzer bir zorluğunuz mu var?",
      similarChallengeSub: "Bize projenizden bahsedin — genellikle bir gün içinde yanıt veririz.",
      startConversation: "Bir sohbet başlatın",
      nextStep: "Sonraki Adım",
      readyHeadline: "Bu tür sonuçlara hazır mısınız?",
      readySub: "Göç, veri merkezi veya ağ projeniz hakkında mühendislik ekibimizle konuşun.",
      items: [
