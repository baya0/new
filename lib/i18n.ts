...
export const translations = {
  en: {
      ...
      items: [
        {
          ...
          desc: "Successful migration project for Nike Turkey stores across 9 sites and cities. Tasks included: BOM Validation, Cable Survey & Labeling, Device Decommissioning, Rack & Stack (new switches), Rack Redesign, Patchwork, Smoke Testing.",
        ...
        },
        {
          ...
          desc: "24-month migration project in Istanbul, Turkey. Help desk support engineers assisted end users with devices running new Windows 11 image.",
        ...
        },
        {
          ...
          desc: "Expert team transforms cabling patch matrix into organized cabling at client's data center.",
        ...
        },
        {
          ...
          desc: "Minimizing electronic waste, secure data deletion before eco-friendly recycling and disposal of end-of-life network equipment. There Is No Planet B.",
        ...
        },
        {
          ...
          desc: "Infra team installed Palo Alto firewalls at client data center, including rack mounting.",
        ...
        },
        {
          ...
          desc: "Configured and installed new network devices including Cisco access points at a manufacturing site. Received and configured devices, installed Cisco APs, worked closely with client to ensure minimal disruption.",
        ...
        },
        {
          ...
          desc: "Infra squad racked & stacked 60 servers at client data center in Istanbul, Turkey.",
        ...
        },
        {
          icon: "📶", color: "cyan",
          title: "WiFi Survey",
          desc: "Skilled wireless engineers conducted a comprehensive WiFi survey at a client manufacturing site, creating WiFi Heatmaps for coverage optimization.",
        ...
        },
        {
          ...
          desc: "When new device delivery was delayed, Supportiva provided rental network devices so the client could activate their site without waiting.",
        ...
        },
        {
          ...
          desc: "Seamless migration from Windows 10 to Windows 11, upgrading a total of 36 devices.",
    ...
    blog: {
      ...
      posts: [
        { cat: "Infrastructure", title: "Unveiling the Future with WiFi 7: Ruijie's RG-RAP73HD Leads the Charge", desc: "WiFi 7 is here and it's changing the game. Explore how Ruijie's latest access point delivers next-gen wireless performance for enterprise environments.", date: "Dec 15, 2024", read: "6 min read" },
        { cat: "Cloud", title: "Microsoft's Copilot: The Future of Productivity Unleashed", desc: "How Microsoft's AI-powered Copilot is transforming the way businesses work, from document creation to data analysis and beyond.", date: "Nov 28, 2024", read: "8 min read" },
        { cat: "Infrastructure", title: "InfiniBand VS Ethernet", desc: "A deep technical comparison of InfiniBand and Ethernet for data center networking. Which one is right for your infrastructure needs?", date: "Oct 20, 2024", read: "10 min read" },
        { cat: "Cloud", title: "The Evolution of Cloud Computing: Trends and Predictions for the Future", desc: "Cloud computing continues to evolve rapidly. Here are the key trends shaping the future and what they mean for your business.", date: "Sep 15, 2024", read: "7 min read" },
        { cat: "Migration", title: "Adopting Agility in IT Daily Life", desc: "How adopting agile methodologies in your IT operations can improve efficiency, reduce waste, and accelerate delivery.", date: "Aug 10, 2024", read: "5 min read" },
        { cat: "Cloud", title: "The Role of IT in Ensuring Business Continuity", desc: "Why a robust IT infrastructure is critical for business continuity and how to build resilience into your systems.", date: "Jul 5, 2024", read: "9 min read" },
      ],
    },
    contact: {
      eyebrow: "Contact Us",
