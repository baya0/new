...
readySub: "Speak with our engineering team about your deployment, data center, or network project.",
      items: [
        {
          ...
          tags: ["Deployment", "9 Sites", "Rack & Stack"],
...
readySub: "تحدث مع فريقنا الهندسي حول مشروع التحديث أو مركز البيانات أو الشبكات.",
...
readySub: "Yenileme, veri merkezi veya ağ projeleriniz için mühendislik ekibimizle iletişime geçin.",
      items: [
