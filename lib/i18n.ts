...
export const translations = {
  en: {
    ...
    projects: {
      ...
      sub: "From multinational upgrades to data center builds — work delivered on the ground by our engineering teams.",
      countOne: "Project",
      countMany: "Projects",
      ...
      readySub: "Talk to our engineering team about your upgrade, datacenter, or network project.",
      items: [
        {
          icon: "👟", color: "blue", image: "/images/projects/nike-migration.jpg",
          title: "Nike Turkey Upgrade Project",
          desc: "Successful upgrade project for Nike Turkey stores across 9 sites and cities.",
          fullDesc: "We're thrilled to announce the successful completion of an upgrade project for Nike Turkey stores, achieved across nine different sites and cities. This accomplishment was made possible through the collaboration of multinational teams, whose dedication and commitment have added a significant milestone to our success journey.",
          ...
          tags: ["Upgrade", "9 Sites", "Rack & Stack"],
        ...
        },
        {
          ...
          desc: "24-month upgrade project in Istanbul, Turkey.",
          fullDesc: "Our team of help desk support engineers successfully concluded a 24-month upgrade project in Istanbul, Turkey, for our client. Throughout this period, their primary responsibility involved assisting the client's end users by supplying them with devices equipped with the new Windows 11 image.",
        ...
        },
        {
          ...
          title: "Windows 10 to Windows 11 Upgrade",
          desc: "Seamless upgrade of 36 devices.",
          fullDesc: "Exciting times at Supportiva as we recently wrapped up a seamless upgrade from Windows 10 to Windows 11 for one of our esteemed clients, upgrading a total of 36 devices! This project was a significant milestone, reflecting our commitment to providing top-notch IT services and solutions.",
          tags: ["Windows 11", "36 Devices", "Upgrade"],
          location: "Client Site",
          year: "2024",
  ...
  ar: {
    ...
    projects: {
      ...
      readySub: "تحدث إلى فريق الهندسة لدينا حول مشروع الترقية أو مركز البيانات أو الشبكة.",
      items: [
        { icon: "👟", color: "blue", image: "/images/projects/nike-migration.jpg", title: "نايك تركيا — ترقية متعددة المواقع", desc: "ترقية شبكية ناجحة عبر 9 متاجر نايك في 9 مدن تركية مع فرق متعددة الجنسيات.", fullDesc: "نفخر بإتمام مشروع ترقية ناجح لمتاجر نايك تركيا عبر تسعة مواقع ومدن مختلفة. تحقق هذا الإنجاز بفضل تعاون فرق متعددة الجنسيات.", bullets: ["التحقق من BOM: فحص الأجهزة والكابلات", "مسح الكابلات والتسمية: مسح مسبق وتسمية جميع المحولات", "إزالة الأجهزة: إزالة أجهزة الشبكة من الرف الرئيسي", "تركيب المحولات الجديدة", "إعادة تصميم الرفوف", "التوصيلات بين المحولات ولوحات التوصيل", "اختبار الدخان: فحص جميع الأنظمة"], tags: ["ترقية", "9 مواقع", "تركيب"], location: "تركيا — 9 مدن" },
        { icon: "💻", color: "green", image: "/images/projects/l1-support.jpg", title: "دعم L1 في الموقع — إسطنبول", desc: "مشروع ترقية مدته 24 شهرًا في إسطنبول لنشر صورة Windows 11.", fullDesc: "أنهى فريق مهندسي الدعم لدينا بنجاح مشروع ترقية مدته 24 شهرًا في إسطنبول، تركيا. تضمنت مهمتهم الأساسية مساعدة المستخدمين النهائيين بتزويدهم بأجهزة مجهزة بصورة Windows 11 الجديدة.", tags: ["دعم L1", "Windows 11", "24 شهر"], location: "إسطنبول، تركيا" },
        ...
        { icon: "🪟", color: "blue", image: "/images/projects/win11-migration.jpg", title: "ترقية من Windows 10 إلى 11", desc: "ترقية سلسة لـ36 جهازًا بدون فقدان بيانات أو توقف عمليات.", fullDesc: "أنجزنا بنجاح ترقية سلسة من Windows 10 إلى Windows 11 لأحد عملائنا، مع ترقية 36 جهازًا! يمثل هذا المشروع إنجازًا كبيرًا يعكس التزامنا بتقديم خدمات تقنية على أعلى مستوى.", tags: ["Windows 11", "36 جهاز", "ترقية"], location: "موقع العميل" },
      ],
  ...
  tr: {
    ...
    projects: {
      ...
      sub: "Çok uluslu yükseltmelerden veri merkezi inşaatlarına — mühendislik ekiplerimizin sahada teslim ettiği işler.",
      countOne: "Proje",
      countMany: "Proje",
      ...
      readySub: "Yükseltme, veri merkezi veya ağ projeniz hakkında mühendislik ekibimizle konuşun.",
      items: [
        { icon: "👟", color: "blue", image: "/images/projects/nike-migration.jpg", title: "Nike Türkiye — Çok Lokasyonlu Yükseltme", desc: "9 şehirde 9 Nike Türkiye mağazasının başarılı ağ yükseltmesi.", fullDesc: "Nike Türkiye mağazaları için 9 farklı lokasyon ve şehirde gerçekleştirilen yükseltme projemizi başarıyla tamamladık. Bu başarı, çok uluslu ekiplerin özverili çalışmasıyla mümkün oldu.", bullets: ["BOM Doğrulaması: Cihazlar, PDU'lar ve kablolar doğrulandı", "Kablo Anketi ve Etiketleme: Ön kontrol anketi ve mevcut tüm anahtarların etiketlenmesi", "Cihaz Sistemden Çıkarma: Ana MDF rack ağ cihazlarının kaldırılması", "Rack Kurulumu: Yepyeni anahtarların montajı", "Rack Yeniden Tasarımı: Düzenli ve organize görünüm", "Bağlantı: Anahtarlar ve patch paneller arası bağlantılar", "Duman Testi: Tüm mağaza sistemlerinin kontrolü"], tags: ["Yükseltme", "9 Lokasyon", "Rack Kurulumu"], location: "Türkiye — 9 Şehir" },
        { icon: "💻", color: "green", image: "/images/projects/l1-support.jpg", title: "Yerinde L1 Desteği — İstanbul", desc: "İstanbul'da 24 aylık yükseltme projesi.", fullDesc: "Yardım masası destek mühendislerimiz İstanbul, Türkiye'de 24 aylık yükseltme projesini başarıyla tamamladı. Temel sorumlulukları son kullanıcılara yeni Windows 11 imajlı cihazlar sağlamaktı.", tags: ["L1 Desteği", "Windows 11", "24 Ay"], location: "İstanbul, Türkiye" },
        ...
        { icon: "🪟", color: "blue", image: "/images/projects/win11-migration.jpg", title: "Windows 10'dan 11'e Yükseltme", desc: "36 cihazda sorunsuz yükseltme.", fullDesc: "Müşterimiz için Windows 10'dan Windows 11'e sorunsuz bir yükseltme gerçekleştirerek toplamda 36 cihazı yükselttik! Bu proje, birinci sınıf BT hizmetleri sunma taahhüdümüzü yansıtan önemli bir kilometre taşıdır.", tags: ["Windows 11", "36 Cihaz", "Yükseltme"], location: "Müşteri Lokasyonu" },
      ],
