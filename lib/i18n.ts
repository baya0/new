...
export const translations = {
  en: {
    ...
    solutions: {
      ...
      services: [
        {
          icon: "🖥", color: "blue", title: "IT Consulting and Strategy",
          desc: "At Supportiva, we provide tailored IT consulting and strategy to help you achieve your business goals. Our team of experts will work with you to understand your business needs and recommend the best IT solutions that fit your specific requirements. Whether it's cloud migration, application development, or software integration, we've got you covered.",
